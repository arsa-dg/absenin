...
import { AttendanceResponseDto, GetAllAttendanceResponseDto } from './attendance.dto';
...
describe('AttendanceController', () => {
  ...
  const mockCreateResult: AttendanceResponseDto = {
  ...
  describe('create', () => {
    it('should call attendanceService.create with the user ID and return success', async () => {
      mockService.create.mockResolvedValue(mockCreateResult);
